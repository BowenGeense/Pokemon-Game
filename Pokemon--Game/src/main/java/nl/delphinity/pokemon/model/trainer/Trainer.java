...
// import nl.delphinity.pokemon.model.area.getPokemonCollection;
// import nl.delphinity.pokemon.model.area.pokemon;
...
public class Trainer {
	...
	private boolean catchPokemon(Pokemon pokemon) {
		...
		if (catchChance > 50) {
			...
			System.out.println("----------------");
			System.out.println("You caught " + pokemon.getPokedata());
			System.out.println("----------------");
		...
		System.out.println("----------------");
		System.out.println(pokemon.getPokedata() + " broke your pokeball");
		System.out.println("----------------");
		return false;
	}
	...
	public void showBadges() {
		...
		System.out.println("----------------");
		if (badges != null) {
			System.out.println("you have to defeat a gym leader to get a badge you dont have any badges yet");
			System.out.println("----------------");
		}
	}
